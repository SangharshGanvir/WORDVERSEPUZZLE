...
// Each list contains words for different word lengths (3, 4, 5, and 6 letters)
// These words can be used as solutions or valid guesses

// 3-letter words
const VALID_WORDS_3 = [
    "act", "add", "age", "ago", "aid", "aim", "air", "all", "and", "any",
    "arm", "art", "ask", "ate", "awe", "bad", "bag", "ban", "bar", "bat",
    "bay", "bed", "bee", "beg", "bet", "bid", "big", "bin", "bit", "boa",
    "bob", "bog", "bow", "box", "boy", "bud", "bug", "bum", "bun", "bus",
    "but", "buy", "cab", "can", "cap", "car", "cat", "cog", "cop", "cow",
    "cry", "cup", "cut", "dad", "dam", "day", "den", "dew", "did", "die",
    ...
    "fur", "gap", "gas", "gel", "gem", "get", "gig", "gin", "god", "got",
    "gum", "gun", "gut", "guy", "gym", "had", "ham", "has", "hat", "hay",
    "hem", "hen", "her", "hey", "hid", "him", "hip", "his", "hit", "hog",
    "hop", "hot", "how", "hub", "hue", "hug", "hum", "hut", "ice", "icy",
    "ill", "ink", "inn", "ion", "its", "ivy", "jam", "jar", "jaw", "jay",
    "jet", "job", "jog", "jot", "joy", "jug", "jut", "keg", "key", "kid",
    "kin", "kit", "lab", "lad", "lag", "lap", "law", "lay", "led", "leg",
    "let", "lid", "lie", "lip", "lit", "log", "lot", "low", "lug", "lye",
    "mad", "man", "map", "mat", "may", "men", "met", "mix", "mob", "mod",
    "mom", "mop", "mow", "mud", "mug", "nag", "nap", "nay", "net", "new",
    "nip", "nod", "nor", "not", "now", "nun", "nut", "oak", "odd", "off",
    "oft", "oil", "old", "one", "orb", "ore", "our", "out", "owe", "owl",
    "own", "pad", "pal", "pan", "pap", "par", "pat", "paw", "pay", "pea",
    "peg", "pen", "pep", "per", "pet", "pew", "pie", "pig", "pin", "pip",
    ...
    "saw", "say", "sea", "see", "set", "sew", "she", "shy", "sic", "sip",
    "sir", "sis", "sit", "six", "ski", "sky", "sly", "sob", "sod", "son",
    "sow", "spa", "spy", "stew", "stir", "stop", "sub", "sue", "sum", "sun",
    "sup", "tab", "tad", "tag", "tan", "tap", "tar", "tat", "tax", "tea",
    "tee", "ten", "the", "thy", "tic", "tie", "til", "tin", "tip", "toe",
    "tog", "tom", "ton", "too", "top", "tow", "toy", "try", "tub", "tug",
    "tut", "two", "ugh", "ump", "urn", "use", "van", "vat", "vex", "via",
    "vie", "vow", "wad", "wag", "wan", "war", "was", "wax", "way", "web",
    "wed", "wee", "wet", "who", "why", "wig", "win", "wit", "woe", "wok",
    "won", "woo", "wow", "wry", "yak", "yam", "yap", "yaw", "yay", "yea",
    "yen", "yes", "yet", "yew", "yip", "you", "yuk", "yum", "zap", "zen",
    "zig", "zip", "zit", "zoo"
];
...
// 6-letter words
const VALID_WORDS_6 = [
    "accept", "access", "accord", "across", "acting", "action", "active", "actual", "advice", "advise",
    ...
    "assist", "assume", "attack", "attend", "august", "author", "autumn", "avenue", "backed", "barely",
    "battle", "beauty", "became", "become", "before", "behalf", "behind", "belief", "belong", "benefit",
...
// Create a map of valid guesses for each word length
const VALID_GUESSES = {
    3: [...VALID_WORDS_3],
    4: [...VALID_WORDS_4],
    5: [...VALID_WORDS_5],
...
// Create a map of valid words for each word length
const VALID_WORDS = {
    3: VALID_WORDS_3,
    4: VALID_WORDS_4,
    5: VALID_WORDS_5,
